    ...
    <div class="my-app">
      <div class="overlay">
        ...
        <div class="content">
          ...
          <div class="spans">
            <img
              src="@/assets/icons/night/cloudy.png"
              alt="Weather Icon"
              class="icon"
            />
            <div>
...
export default {
  ...
  data() {
    return {
      ...
      dayImages: [
        {
          id: 0,
          src: require("@/assets/images/day/clear.jpg"),
          alt: "Sunny day",
        },
        {
          id: 1,
          src: require("@/assets/images/day/cloudy.jpg"),
          alt: "Cloudy day",
        },
        {
          id: 2,
          src: require("@/assets/images/day/rainy.jpg"),
          alt: "Rainy day",
        },
        {
          id: 3,
          src: require("@/assets/images/day/snowy.jpg"),
          alt: "Snowy day",
        },
      ],
      nightImages: [
        {
          id: 0,
          src: require("@/assets/images/night/clear.jpg"),
          alt: "Clear night skies",
        },
        {
          id: 1,
          src: require("@/assets/images/night/cloudy.jpg"),
          alt: "Cloudy night",
        },
        {
          id: 2,
          src: require("@/assets/images/night/rainy.jpg"),
          alt: "Rainy night",
        },
        {
          id: 3,
          src: require("@/assets/images/night/snowy.jpg"),
          alt: "Snowy night",
        },
      ],
      dayIcons: [
        {
          id: 0,
          src: require("@/assets/icons/day/clear.png"),
          alt: "Sunny day",
        },
        {
          id: 1,
          src: require("@/assets/icons/day/cloudy.png"),
          alt: "Cloudy day",
        },
        {
          id: 2,
          src: require("@/assets/icons/day/rainy.png"),
          alt: "Rainy day",
        },
        {
          id: 3,
          src: require("@/assets/icons/day/snowy.png"),
          alt: "Snowy day",
        },
      ],
      nightIcons: [
        {
          id: 0,
          src: require("@/assets/icons/night/clear.png"),
          alt: "Clear skies",
        },
        {
          id: 1,
          src: require("@/assets/icons/night/cloudy.png"),
          alt: "Cloudy night",
        },
        {
          id: 2,
          src: require("@/assets/icons/night/rainy.png"),
          alt: "Rainy night",
        },
        {
          id: 3,
          src: require("@/assets/icons/night/snowy.png"),
          alt: "Snowy night",
        },
      ],
    };
  ...
  methods: {
    ...
    getWeatherData() {
      fetch(
        `https://api.weatherapi.com/v1/current.json?key=${this.apiKey}&q=${this.getCity}`
      )
        ...
        .then((data) => {
          ...
          this.date = `${this.getDay(d, m, y)}, ${this.getMonth(
            d,
            m,
            y
          )} ${d} ${y}`;
    ...
    getMyLocationWeatherData() {
      ...
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition((position) => {
          ...
          fetch(
            `https://api.weatherapi.com/v1/current.json?key=${this.apiKey}&q=${latitude},${longitude}`
          )
            .then((response) => response.json())
            .then((data) => {
              this.city = data.location.name;
